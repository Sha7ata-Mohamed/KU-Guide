"""
Django settings for Kuwait_University project.
...
# Security settings for development - PREVENT HTTPS REDIRECT
...
ROOT_URLCONF = 'Kuwait_University.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [ BASE_DIR / 'KUGuide' / 'templates' ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Kuwait_University.wsgi.application'
